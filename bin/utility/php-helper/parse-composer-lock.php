...
foreach ($vendorPackages as $vendorPackage) {
    $vendorPackagesReferences[$vendorPackage['name']]['reference'] = $vendorPackage['source']['reference'];
    $vendorPackagesReferences[$vendorPackage['name']]['version'] = $vendorPackage['version'];
}
